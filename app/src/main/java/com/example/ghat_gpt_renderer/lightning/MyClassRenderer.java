...
import com.example.ghat_gpt_renderer.light2.Shader;
...
public class MyClassRenderer implements GLSurfaceView.Renderer{
    ...
    //шейдерный объект
    private com.example.ghat_gpt_renderer.light2.Shader mShader;
    private com.example.ghat_gpt_renderer.light2.Shader mShader1;
    private com.example.ghat_gpt_renderer.light2.Shader mShader2;
    private com.example.ghat_gpt_renderer.light2.Shader mShader3;
    private com.example.ghat_gpt_renderer.light2.Shader mShader4;
    ...
    public MyClassRenderer(Context context) {
        ...
        ByteBuffer vertex2 = ByteBuffer.allocateDirect(vertexArray2.length*4);
        vertex2.order(ByteOrder.nativeOrder());
        vertexBuffer2 = vertex2.asFloatBuffer();
        vertexBuffer2.position(0);

        ByteBuffer vertex3 = ByteBuffer.allocateDirect(vertexArray3.length*4);
        ...
        ByteBuffer color2 = ByteBuffer.allocateDirect(colorArray1.length*4);
    ...
    public void onSurfaceCreated(GL10 unused, EGLConfig config) {
        ...
        mShader=new com.example.ghat_gpt_renderer.light2.Shader(vertexShaderCode, fragmentShaderCode);
        ...
        mShader1 = new com.example.ghat_gpt_renderer.light2.Shader(vertexShaderCode, fragmentShaderCode);
        mShader1.linkVertexBuffer(vertexBuffer1);
        mShader1.linkNormalBuffer(normalBuffer);
        mShader1.linkColorBuffer(colorBuffer1);

        mShader2 = new com.example.ghat_gpt_renderer.light2.Shader(vertexShaderCode, fragmentShaderCode);
        mShader2.linkVertexBuffer(vertexBuffer2);
        mShader2.linkNormalBuffer(normalBuffer);
        mShader2.linkColorBuffer(colorBuffer2);

        mShader3 = new com.example.ghat_gpt_renderer.light2.Shader(vertexShaderCode, fragmentShaderCode);
