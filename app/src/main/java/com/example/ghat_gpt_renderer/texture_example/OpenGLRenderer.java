package com.example.ghat_gpt_renderer.texture_example;
...
public class OpenGLRenderer implements Renderer {
    ...
    private void prepareData() {
        ...
        texture = TextureUtils.loadTexture(context, R.drawable.textures1);
        texture1 = TextureUtils.loadTexture(context, R.drawable.textures1);
        texture2 = TextureUtils.loadTexture(context, R.drawable.textures1);
